...
s3eFBSession* s3eFBInit_platform(const char* appId)
{
	...
	jobject ret = env->CallObjectMethod(g_Obj, g_s3eFBInit, appId_jstr);
...
s3eFBDialog* s3eFBDialog_WithAction_platform(s3eFBSession* session, const char* action)
{
	...
	jobject ret = env->CallObjectMethod(g_Obj, g_s3eFBDialog_WithAction, (jobject)session, action_jstr);
    ret = env->NewGlobalRef(ret);
    addKnownObject(ret);
...
s3eResult s3eFBDialog_AddParamString_platform(s3eFBDialog* dialog, const char* name, const char* value)
{
	...
	return (s3eResult)env->CallIntMethod(g_Obj, g_s3eFBDialog_AddParamString, (jobject)dialog, name_jstr, value_jstr);
}
...
s3eResult s3eFBDialog_AddParamNumber_platform(s3eFBDialog* dialog, const char* name, int64 value)
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring name_jstr = env->NewStringUTF(name);
	return (s3eResult)env->CallIntMethod(g_Obj, g_s3eFBDialog_AddParamNumber, (jobject)dialog, name_jstr, value);
}
...
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring str = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBDialog_ErrorString, (jobject)dialog);
...
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring str = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBDialog_DidNotCompleteWithUrl, (jobject)dialog);
    return getCString(str);
}
...
s3eFBRequest* s3eFBRequest_WithMethodName_platform(s3eFBSession* session, const char* methodName, const char* httpMethod)
{
	...
	jobject ret = env->CallObjectMethod(g_Obj, g_s3eFBRequest_WithMethodName, (jobject)session, methodName_jstr, httpMethod_jstr);
    ret = env->NewGlobalRef(ret);
    addKnownObject(ret);
...
s3eFBRequest* s3eFBRequest_WithGraphPath_platform(s3eFBSession* session, const char* graphPath, const char* httpMethod)
{
    ...
    if (!httpMethod)
        httpMethod = "GET";
	jstring httpMethod_jstr = env->NewStringUTF(httpMethod);
	jobject ret = env->CallObjectMethod(g_Obj, g_s3eFBRequest_WithGraphPath, (jobject)session, graphPath_jstr, httpMethod_jstr);
    ret = env->NewGlobalRef(ret);
    addKnownObject(ret);
...
s3eFBRequest* s3eFBRequest_WithURL_platform(s3eFBSession* session, const char* url, const char* httpMethod)
{
    ...
    if (!httpMethod)
        httpMethod = "GET";
	jstring httpMethod_jstr = env->NewStringUTF(httpMethod);
	jobject ret = env->CallObjectMethod(g_Obj, g_s3eFBRequest_WithURL, (jobject)session, url_jstr, httpMethod_jstr);
	ret = env->NewGlobalRef(ret);
    addKnownObject(ret);
	return (s3eFBRequest*)ret;
}
...
s3eResult s3eFBRequest_AddParamString_platform(s3eFBRequest* request, const char* name, const char* value)
{
	...
	jstring name_jstr = env->NewStringUTF(name);
	jstring value_jstr = env->NewStringUTF(value);
	return (s3eResult)env->CallIntMethod(g_Obj, g_s3eFBRequest_AddParamString, (jobject)request, name_jstr, value_jstr);
}
...
s3eResult s3eFBRequest_AddParamNumber_platform(s3eFBRequest* request, const char* name, int64 value)
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring name_jstr = env->NewStringUTF(name);
	return (s3eResult)env->CallIntMethod(g_Obj, g_s3eFBRequest_AddParamNumber, (jobject)request, name_jstr, value);
}
...
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring res = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBRequest_ErrorString, (jobject)request);
	return getCString(res);
}
...
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring res = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBRequest_ResponseRaw, (jobject)request);
	return getCString(res);
}
...
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring res = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBRequest_ResponseAsString, (jobject)request);
	return getCString(res);
}
...
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring str = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBRequest_ResponseArrayItemAsString, (jobject)request, index);
	return getCString(str);
}
...
s3eBool s3eFBRequest_ResponseDictionaryContainsItem_platform(s3eFBRequest* request, const char* key)
{
	...
	return (s3eBool)env->CallBooleanMethod(g_Obj, g_s3eFBRequest_ResponseDictionaryContainsItem, (jobject)request, key_jstr);
}
...
const char* s3eFBRequest_ResponseDictionaryItemAsString_platform(s3eFBRequest* request, const char* key)
{
    JNIEnv* env = s3eEdkJNIGetEnv();
	jstring key_jstr = env->NewStringUTF(key);
	jstring str = (jstring)env->CallObjectMethod(g_Obj, g_s3eFBRequest_ResponseDictionaryItemAsString, (jobject)request, key_jstr);
	return getCString(str);
}
